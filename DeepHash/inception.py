...
triplet_train_dataset = TripletDataset(list_path=train, isTest=False,transform_anchor = preprocess,
            transform_positive=preprocess,
            transform_negative=preprocess)
